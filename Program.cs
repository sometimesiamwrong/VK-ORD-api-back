...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("https://criminally-astute-kangaroo.cloudpub.ru","https://ad-layer.ru", "https://server273.hosting.reg.ru", "http://ad-lawyer.ru", "https://ad-lawyer.ru", "http://localhost", "http://localhost:5173")
            .AllowAnyMethod()
            .AllowAnyHeader()
            .AllowCredentials();
    });
