...
namespace VkOrdApiWrapper.Security
{
    public class TokenService : ITokenService
    {
        ...
        public TokenService(IOptions<JwtConfiguration> jwtOptions, ApplicationDbContext db)
        {
            _jwt = jwtOptions.Value;
            _db = db;
        }

        public TokenPair GenerateTokens(User user, string? deviceId = null, string? ip = null)
        {
