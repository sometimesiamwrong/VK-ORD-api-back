...
namespace WebApp.Repositories.Implementation.VkOrd.Creative
{
    ...
    public class CreateCreativeRepository : ICreateCreativeRepository
    {
        ...
        public async Task<VkOrdCreativeV3RequestResponse> CreateCreative(string externalId, VkOrdCreativeV3Request request, CancellationToken cancellationToken)
        {
            ...
            return new VkOrdCreativeV3RequestResponse
            {
                Erid = response.Erid,
            };
        }
