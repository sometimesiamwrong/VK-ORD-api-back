...
// Настройка конфигурации для использования webapp.appsettings.json
...
// Регистрация всех репозиториев и сервисов
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    var xmlPath = Path.Combine(Path.GetDirectoryName(assembly.Location) ?? AppContext.BaseDirectory, xmlFile);
