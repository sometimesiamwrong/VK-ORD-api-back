...
public sealed class VkOrdApiContractResponse
{
    /// <summary>
    ...
    /// <summary>
    /// Признак того, есть ли у договора дополнительные соглашения.
    /// </summary>
    ...
    /// <summary>
    /// Список полей, запрещенных для редактирования, а так же причины такого запрета.
    /// </summary>
    [JsonPropertyName("locked_fields")]
    public List<VkOrdApiLockedField> LockedFields { get; set; } = new();
}
