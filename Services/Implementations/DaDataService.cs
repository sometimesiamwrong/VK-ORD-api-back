...
namespace VkOrdApiWrapper.Services.Implementations
{
	public class DaDataService : IDaDataService
	{
		...
		public DaDataService(IDaDataApiClient client, IOptions<DaDataConfiguration> config, ILogger<DaDataService> logger, IDistributedCache cache)
		{
			_client = client;
		...
		public async Task<DaDataPartyShortResponse?> FindPartyByInnAsync(string inn, CancellationToken cancellationToken = default)
		{
